	...
	public BusinessCont() {
		...
		scrollPane.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				busfirstnametxb.setText(table.getValueAt(table.getSelectedRow(),2).toString());
				buslastnametxb.setText(table.getValueAt(table.getSelectedRow(), 3).toString());
				busemailtxb.setText(table.getValueAt(table.getSelectedRow(),4).toString());
				busaddresslineonetxb.setText(table.getValueAt(table.getSelectedRow(),5).toString());
				busaddresslinetwotxb.setText(table.getValueAt(table.getSelectedRow(),6).toString());
				buscitytxb.setText(table.getValueAt(table.getSelectedRow(),7).toString());
				buspostcodetxb.setText(table.getValueAt(table.getSelectedRow(),8).toString());
				busphonetxb.setText(table.getValueAt(table.getSelectedRow(), 9).toString());
			}
		});
