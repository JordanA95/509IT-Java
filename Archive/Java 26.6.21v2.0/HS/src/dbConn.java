...
public class dbConn {
	...
	public void AddPersonal (String f, String l, String em, String addr1, String addr2, String city, String postcode, String perphone, String id)
	{
		String sql="(call InsertPersonal(?, ?, ?, ?, ?, ?, ?, ?))";
		try {
			java.sql.CallableStatement cst = con.prepareCall(sql);
			...
			cst.setString(1, addr2);
			cst.setString(1, city);
			cst.setString(1, postcode);
			cst.setString(1, perphone);
			cst.executeQuery();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public ResultSet UpdatePersonal (String f, String l, String p, String em, String addr1, String addr2, String city, String postcode, String id)
	{
		ResultSet rs=null;
	...
	public void AddBusiness (String f, String l, String em, String addr1, String addr2, String city, String postcode, String busphone, String id)
	{
		String sql="(call InsertBusiness(?, ?, ?, ?, ?, ?, ?, ?))";
		try {
			java.sql.CallableStatement cst = con.prepareCall(sql);
	...
	public ResultSet UpdateBusiness (String f, String l, String p, String em, String addr1, String addr2, String city, String postcode, String id)
	{
		ResultSet rs=null;
