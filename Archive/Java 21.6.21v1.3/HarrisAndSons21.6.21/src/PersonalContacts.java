...
public class PersonalContacts extends JFrame {
	...
	public PersonalContacts() {
		...
		personalcontactstable = new JTable();
		personalcontactstable.setBackground(Color.WHITE);
		personalcontactstable.setBounds(592, 206, -564, 159);
		contentPane.add(personalcontactstable);
