...
public class dbConn {
	...
	public void AddPersonal (String f, String l, String em, String addr1, String addr2, String city, String postcode, String perphone)
	{
		String sql="(call AddPersonal(?, ?, ?, ?, ?, ?, ?, ?))";
		try {
			java.sql.CallableStatement cst = con.prepareCall(sql);
			cst.setString(1, f);
			cst.setString(2, l);
	...
	public void AddBusiness (String f, String l, String em, String addr1, String addr2, String city, String postcode, String busphone)
	{
		String sql="(call AddBusiness(?, ?, ?, ?, ?, ?, ?, ?))";
		try {
			java.sql.CallableStatement cst = con.prepareCall(sql);
	...
	public ResultSet UpdateBusiness (String id, String f, String l, String p, String em, String addr1, String addr2, String city, String postcode, String busphone)
	{
		ResultSet rs=null;
