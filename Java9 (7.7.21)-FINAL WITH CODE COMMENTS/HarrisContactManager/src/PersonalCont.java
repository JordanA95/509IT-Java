...
public class PersonalCont extends JFrame {
	...
	public PersonalCont() {
		...
		/*Set Statuslbl text to -. Declare new JTable. Initiate the GetAllPersonal stored procedure. Initiate DbConn.*/
		...
		/*Declare all buttons and set savenewbtn to diabled..*/
		...
		/*When Refresh button clicked, use the GetAllPersonal stored procedure to repopulate the table with the values in the database.*/
		...
		/*When savenewbtn button clicked, if updatemode is true, then the form will be set up for updating and UpdatePersonal stored procedure is run.*/
		savenewbtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
				/*If updatemode is true, then the form will be set up to update an existing contact, and UpdatePersonal stored procedure is run.*/
				if (updatemode == true)
				{
				...
				/*If updatemode is false, then the form will be set up to add a new contact, and AddPersonal stored procedure is run.*/
				else
				{
					String f=perfirstnametxb.getText();
					String l=perlastnametxb.getText();
				...
				/*After AddPersonal or UpdatePersonal stored procedure is run, all textboxes are cleared and disabled. All buttons enabled are reset.*/
				updateselectedbtn.setEnabled(true);
				addnewbtn.setEnabled(true);
				saveselectedbtn.setEnabled(false);
				savenewbtn.setEnabled(false);
		...
		/*Button to delete a contact by initiating the DeletePersonal stored procedure, then updating the table. Empty all textbox values.*/
