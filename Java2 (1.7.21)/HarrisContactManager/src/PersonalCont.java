	...
	public PersonalCont() {
		...
		scrollPane.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				perfirstnametxb.setText(table.getValueAt(table.getSelectedRow(),2).toString());
				perlastnametxb.setText(table.getValueAt(table.getSelectedRow(), 3).toString());
				peremailtxb.setText(table.getValueAt(table.getSelectedRow(),4).toString());
				peraddresslineonetxb.setText(table.getValueAt(table.getSelectedRow(),5).toString());
				peraddresslinetwotxb.setText(table.getValueAt(table.getSelectedRow(),6).toString());
				percitytxb.setText(table.getValueAt(table.getSelectedRow(),7).toString());
				perpostcodetxb.setText(table.getValueAt(table.getSelectedRow(),8).toString());
				perphonetxb.setText(table.getValueAt(table.getSelectedRow(), 9).toString());
			}
		});
